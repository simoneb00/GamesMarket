...
public class ExchangeItemGraphicController {
    ...
    public void contact() {
        ...
        try {
            ...
            gamesmarket.graphic_control.mobile.exchange.ContactWindowGraphicController contactWindowGraphicController = new ContactWindowGraphicController(usernameLabel.getText());
